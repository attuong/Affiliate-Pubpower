...
class ezSQL_mysqli extends ezSQLcore {
     ...
     */
    public function __construct($dbuser = '', $dbpassword = '', $dbname = '', $dbhost = 'localhost', $dbport = 3306, $charset = '') {
...
// quick_connect
     ...
     * @return boolean
     */
    public function connect($dbuser = '', $dbpassword = '', $dbhost = 'localhost', $dbport = 3306, $charset = '') {
        ...
        $this->_dbport = empty($dbport) ? $this->_dbport : $dbport;
        ...
        } else if (!$this->dbh = mysqli_connect($this->_dbhost, $this->_dbuser, $this->_dbpassword, $this->_dbname, $this->_dbport)) {
...
// select
    ...
    public function escape($str) {
        ...
        if (!isset($this->dbh) || !$this->dbh) {
            ...
            $this->select($this->_dbname, $this->_charset);
        }
